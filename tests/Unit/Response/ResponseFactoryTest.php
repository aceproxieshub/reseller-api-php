...
final class ResponseFactoryTest extends TestCase
{
    ...
    {
        $response = $this->factory->create(
            '{"data":{"items":[{"code":"D32365E0C629B-170726","orderId":"019f6fae-623b-7142-a81f-238826fbd8dd","status":"active","type":"dc_proxy","amount":{"amount":1,"unit":"IP"},"auth":{"method":"ip"},"createdAt":"2026-07-17T10:45:27+00:00","startedAt":"2026-07-17T10:45:28+00:00","expiredAt":"2026-08-16T10:45:28+00:00"}],"limit":50,"page":1}}',
            ListResponse::class,
            200,
        );
        ...
        self::assertSame('dc_proxy', $response->items[0]->type);
    ...
    {
        $response = $this->factory->create(
            '{"data":{"amount":{"amount":1,"unit":"IP"},"auth":{"method":"ip"},"code":"CCD9F42D9TGMZ-040426","createdAt":"2026-08-08T12:00:00+00:00","expiresAt":null,"isRecurring":false,"orderId":850,"orderUuid":"0758a20a-b66e-4295-9131-cb9d0fd953f6","price":{"amount":18.59,"currency":"USD"},"protocol":"http","type":"dc_proxy","startedAt":null,"status":"active","userId":"user-1"}}',
        ...
        self::assertSame('dc_proxy', $response->type);
        self::assertSame('dc_proxy', $response->serviceType);
